...
{
    public class PaymentRecurTestsV2 : Base.PaymentTestsV2
    {
        public PaymentRecurTestsV2(string driverAlias) : base(driverAlias)
        {
        }
        ...
        public async Task Payment_Card_Recur(Product[] products, PayexInfo payexInfo, Checkout checkout)
        {
        ...
        private static string GeneratePayeeReference()
        {
