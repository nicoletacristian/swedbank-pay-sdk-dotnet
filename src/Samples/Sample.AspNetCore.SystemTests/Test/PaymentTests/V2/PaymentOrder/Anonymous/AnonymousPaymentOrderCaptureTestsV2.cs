...
{
    public class AnonymousPaymentOrderCaptureTestsV2 : Base.PaymentTestsV2
    {
        public AnonymousPaymentOrderCaptureTestsV2(string driverAlias)
            : base(driverAlias)
        {
        }
        ...
        public void Anonymous_PaymentOrder_Card_Capture(Product[] products, PayexInfo payexInfo, Checkout checkout )
        {
        ...
        public void Anonymous_PaymentOrder_Invoice_Capture(Product[] products, PayexInfo payexInfo, Checkout checkout )
        {
            Assert.DoesNotThrowAsync(async () =>
            {
