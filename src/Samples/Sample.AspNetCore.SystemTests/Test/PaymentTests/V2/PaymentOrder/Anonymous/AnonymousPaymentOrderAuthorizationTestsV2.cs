...
{
    public class AnonymousPaymentOrderAuthorizationTestsV2 : Base.PaymentTestsV2
    {
        public AnonymousPaymentOrderAuthorizationTestsV2(string driverAlias)
            : base(driverAlias)
        {
        }
        ...
        public void Anonymous_PaymentOrder_Card_Authorization(Product[] products, PayexInfo payexInfo, Checkout checkout)
        {
        ...
        public void Anonymous_PaymentOrder_Invoice_Authorization(Product[] products, PayexInfo payexInfo, Checkout checkout)
        {
            Assert.DoesNotThrowAsync(async () =>
            {
