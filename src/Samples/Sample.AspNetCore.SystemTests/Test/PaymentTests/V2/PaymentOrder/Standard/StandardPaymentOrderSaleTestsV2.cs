...
{
    public class StandardPaymentOrderSaleTestsV2 : Base.PaymentTestsV2
    {
        public StandardPaymentOrderSaleTestsV2(string driverAlias)
            : base(driverAlias)
        {
        }
        ...
        public void Standard_PaymentOrder_Swish_Sale(Product[] products, PayexInfo payexInfo, Checkout checkout)
        {
