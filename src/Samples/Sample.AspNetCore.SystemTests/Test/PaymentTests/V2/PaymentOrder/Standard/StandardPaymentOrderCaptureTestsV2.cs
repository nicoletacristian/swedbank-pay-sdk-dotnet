...
namespace Sample.AspNetCore.SystemTests.Test.PaymentTests.V2.PaymentOrder.Standard
{
    public class StandardPaymentOrderCaptureTestsV2 : Base.PaymentTestsV2
    {
        ...
        public void Standard_PaymentOrder_Card_Capture(Product[] products, PayexInfo payexInfo, Checkout checkout)
        {
        ...
        public void Standard_PaymentOrder_Invoice_Capture(Product[] products, PayexInfo payexInfo, Checkout checkout)
        {
            Assert.DoesNotThrowAsync(async () =>
            {
