...
namespace Sample.AspNetCore.SystemTests.Test.PaymentTests.V3.PaymentOrder.Standard
{
    public class StandardPaymentOrderAuthorizationTestsV3 : Base.PaymentTestsV3
    {
        public StandardPaymentOrderAuthorizationTestsV3(string driverAlias)
            : base(driverAlias)
        {
        }
