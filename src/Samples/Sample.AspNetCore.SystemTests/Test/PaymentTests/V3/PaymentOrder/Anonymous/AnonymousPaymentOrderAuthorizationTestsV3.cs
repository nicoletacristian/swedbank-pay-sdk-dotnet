...
namespace Sample.AspNetCore.SystemTests.Test.PaymentTests.V3.PaymentOrder.Anonymous
{
    public class AnonymousPaymentOrderAuthorizationTestsV3 : Base.PaymentTestsV3
    {
        public AnonymousPaymentOrderAuthorizationTestsV3(string driverAlias)
            : base(driverAlias)
        {
        }
