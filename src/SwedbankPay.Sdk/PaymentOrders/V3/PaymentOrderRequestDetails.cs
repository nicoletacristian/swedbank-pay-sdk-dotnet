...
namespace SwedbankPay.Sdk.PaymentOrders.V3
{
    ...
    public class PaymentOrderRequestDetails
    {
        ...
        /// <param name="requestDeliveryInfo">Set to true if you want Swedbank Pay to return delivery information from the payment instruments which support this. The delivery information will then be displayed as the shippingAddress.</param>
        /// <param name="restrictedToDeliveryInfoInstruments">Set to true if you want to restrict your payment menu to only include payment instruments which return delivery info.</param>
        /// <param name="productName">Used to tag the payment as Checkout v3. Mandatory for Checkout v3, as you won’t get the operations in the response without submitting this field.</param>
        ...
        protected internal PaymentOrderRequestDetails(Operation operation,
                                                        ...
                                                        string userAgent,
                                                        Language language,
                                                        bool requestDeliveryInfo,
                                                        bool restrictedToDeliveryInfoInstruments,
                                                        string productName,
                                                        IUrls urls,
                                                        IPayeeInfo payeeInfo)
        {
            ...
            RequestDeliveryInfo = requestDeliveryInfo;
            RestrictedToDeliveryInfoInstruments = restrictedToDeliveryInfoInstruments;
        ...
        /// <summary>
        /// Set to true if you want Swedbank Pay to return delivery information from the payment instruments which support this. The delivery information will then be displayed as the shippingAddress. Currently available for Apple Pay only.
        /// </summary>
        public bool RequestDeliveryInfo { get; }

        /// <summary>
        /// Set to true if you want to restrict your payment menu to only include payment instruments which return delivery info.
        /// </summary>
